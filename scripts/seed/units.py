...
SEED_UNITS: list[dict[str, Any]] = [
    {
        "code": "DN1",
        "name": "DN1",
        "contact_name": "PhongND",
        "contact_email": "phongnd@rikkeisoft.com",
        "contact_title": "Division Lead",
        "tech_stack": ["Microsoft Dynamics 365", "D365 CRM", "D365 Business Central", "Azure", "C#"],
        "notes": "Là đơn vị có năng lực mạnh nhất hiện tại về D365. Có hơn 20 members có kinh nghiệm. Có 3 Senior có thể tham gia presale và proposal.",
        "experts": [
            {"name": "ThangLB", "focus_areas": ["D365", "Azure specialist", "Presale"]},
            {"name": "KhanhLM", "focus_areas": ["D365 CRM", "Business Central"]},
            {"name": "HieuTV", "focus_areas": ["Microsoft Dynamics 365"]},
        ],
        "case_studies": [
            {
                "title": "Fujitsu D365 migration",
                "domain": "Retail",
                "tech_stack": ["D365", "Azure"],
                "description": "D365 implementation for retail client in Japan (2022).",
                "url": "https://example.internal/case/dn1-d365",
            },
            {
                "title": "D365 Business Central Rollout",
                "domain": "Manufacturing",
                "tech_stack": ["D365 Business Central"],
                "description": "Full rollout of D365 BC for enterprise.",
                "url": "https://example.internal/case/dn1-d365-bc",
            }
        ],
    },
    {
        ...
        "name": "D5",
        "contact_name": "MinhLN",
        "contact_email": "minhln@rikkeisoft.com",
        "contact_title": "Delivery Lead",
        "tech_stack": ["Microsoft Dynamics 365", "Python", "Data", "Kafka"],
        "notes": "Có kinh nghiệm triển khai các dự án liên quan D365 nhưng hiện chưa có Senior chuyên sâu. Có hơn 10 members có kinh nghiệm.",
        "experts": [
            {"name": "HaPT", "focus_areas": ["Airflow", "Workflow orchestration"]},
            {"name": "TuanBV", "focus_areas": ["Spark", "Distributed processing"]},
            {"name": "MyDL", "focus_areas": ["D365"]},
        ...
        "case_studies": [
            {
                ...
                "url": "https://example.internal/case/dn5-insurance-lakehouse",
            },
            {
                "title": "D365 Minor Module",
                "domain": "Retail",
                "tech_stack": ["D365", "Power Automate"],
                "description": "Support implementation of minor D365 modules.",
                "url": "https://example.internal/case/d5-d365-support",
            },
        ],
    },
    {
